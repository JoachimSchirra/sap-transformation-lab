...
<div class="site-search" data-site-search>
  ...
  {% assign searchable_pages = site.pages | where_exp: "item", "item.search_exclude != true" | where_exp: "item", "item.noindex != true" | where_exp: "item", "item.published != false" | where_exp: "item", "item.title" | sort: "title" %}
  {% capture search_json %}[
